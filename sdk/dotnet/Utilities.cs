...
namespace Pulumi.Awslbcontroller
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Awslbcontroller.version.txt");
    ...
    internal sealed class AwslbcontrollerResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwslbcontrollerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
